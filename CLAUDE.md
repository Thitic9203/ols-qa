...
- ภาษาทุกหัวข้อ = **คนไม่ใช่สายเทคนิคอ่านรู้เรื่อง** · เขียนผ่าน v2 wiki (ห้ามมี `{}` `[]` ในเนื้อความ) · summary ใส่ prefix เช่น `[Improve][OLS][<Component>]` · ใส่ sprint ที่ active เอง
