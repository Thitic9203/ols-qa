...
- **บังคับด้วยเครื่องมือ 10 ชั้น ไม่ใช่ความจำ** — นิยามอยู่ที่ [`tools/name-guard/customer_content.js`](tools/name-guard/customer_content.js) ที่เดียว · ตารางครบ 10 ชั้น + เหตุผลต่อชั้น อยู่ใน [`tools/name-guard/README.md`](tools/name-guard/README.md) §Customer-owned content · ผูกด้วย `customer_content.test.js` (ชื่อจริงจากสแกน 2026-08-25)
