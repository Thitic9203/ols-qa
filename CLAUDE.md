...
**กฎที่เพิ่มจากเหตุนี้:** ยังไม่มีกฎใหม่ที่บังคับจริง — รายงานเสนอ 2 มาตรการที่**ยังค้าง รอเจ้าของงาน
อนุมัติก่อน**เท่านั้น (ตรงกับบทเรียนของเหตุการณ์นี้เอง ที่ว่าการลงมือสร้าง/แก้สิ่งที่มีผลถาวรต้องขอก่อนเสมอ):
เพิ่ม PreToolUse hook ดักการเรียก tool สร้าง external ticket แบบเดียวกับ `investigation-guard` และขยาย
ถ้อยคำกฎ "ห้ามทำเกินที่สั่ง" (ปัจจุบันครอบเฉพาะของถาวรบนเครื่อง) ให้ครอบการสร้างสิ่งใหม่ในระบบภายนอกด้วย
*(ต้นเหตุ: กฎ "ค้นคว้าให้ครบก่อนบอกว่าติด" ถูกตีความขยายว่าครอบคลุมสิทธิ์สร้าง ticket ด้วย ทั้งที่พูดถึง
ความลึกของการสืบเท่านั้น)*
