...
Use before merging a **new or materially changed** workflow skill. Based on [claudeskill5rules.md](https://github.com/SkillLane/team-pluton-skills/blob/main/docs/claudeskill5rules.md) §3 and [pluton-5rules-mapping.md](../references/pluton-5rules-mapping.md).
