...
| `<YYYYMMDD>-post-mortem-report-<N>.md` | รายงานฉบับจริง `N` ไล่จาก 1 ห้ามข้ามและห้ามซ้ำ |

## ดัชนีรายงาน

| # | วันที่ | เรื่อง | ระดับ | ไฟล์ |
|---|--------|--------|-------|------|
| 1 | 2026-09-05 | ลบลิงก์ที่ใช้งานได้ 3 จุด เพราะเชื่อคอมเมนต์ในเทสของตัวเองว่ามันพัง | Low | [20260905-post-mortem-report-1.md](20260905-post-mortem-report-1.md) |
...
4. คัดลอก `TEMPLATE.md` เป็น `<วันที่>-post-mortem-report-<N ถัดไป>.md` แล้วเขียนให้ครบทุกหัวข้อ
