...
|---|-------|----------|----|-------|
| 1 | Learner หน้าแรก `/trending` แสดง error "Cannot GET /trending" | **High** | TC5 | [OLS-35](https://skilllane.atlassian.net/browse/OLS-35) |
| 2 | Thumbnail สื่อทุกรายการใน creator ไม่โหลด แสดง placeholder เทา | Low | TC3 | [OLS-42](https://skilllane.atlassian.net/browse/OLS-42) |
...
|---|------|----|-------|----------|-------|
| 3 | Creator | C04 | Sidebar หายไปในหน้า media management (hamburger แทน) — อาจเป็น viewport/layout bug | Medium | [OLS-42](https://skilllane.atlassian.net/browse/OLS-42) |
| 4 | Learner | L02 | "ลองอีกครั้ง" บน /trending redirect ไป Creator media page แทนที่จะ retry /trending | Medium | [OLS-35](https://skilllane.atlassian.net/browse/OLS-35) |
| 5 | Creator | C04 | Thumbnail placeholder ยืนยันซ้ำ (พบทุก 10 items) | Low | [OLS-42](https://skilllane.atlassian.net/browse/OLS-42) |
...
| # | Role | TC | ปัญหา | Severity | Story |
|---|------|----|-------|----------|-------|
| 6 | Learner | L09 | ปุ่ม "+ สร้างสื่อ" (Creator feature) แสดงใน topbar ของ Learner session — role/permission UI leak | **High** | [OLS-50](https://skilllane.atlassian.net/browse/OLS-50) |
| 7 | Learner | L03 | Learner session เข้าถึงหน้า `/creator/media` ได้โดยไม่ถูก block/redirect (R3) — ยืนยันซ้ำใน R4: **redirect ทำงานถูกต้อง** อาจถูกแก้แล้ว | High→? | [OLS-20](https://skilllane.atlassian.net/browse/OLS-20) |
| 8 | Learner | L02 | ฟังก์ชันค้นหา `/content` ไม่กรองผลลัพธ์ — ค้น "AI" / "วิทย์" ยังคืนค่า 4,500 รายการ (ไม่ตรง OLS-50 AC_02) | **High** | [OLS-50](https://skilllane.atlassian.net/browse/OLS-50) |
| 9 | Learner | L04 | ไม่มี media type filter tab (วิดีโอ/คอร์ส/เส้นทาง) ใน /content — modal "กรองเพิ่ม" ไม่มีตัวกรองประเภท (ไม่ตรง OLS-50 AC_03) | Medium | [OLS-50](https://skilllane.atlassian.net/browse/OLS-50) |
