...
## สรุปบัคทั้งหมด — Sprint 2

| # | ปัญหา | Severity | TC | Story | รายละเอียด |
|---|-------|----------|----|-------|------------|
| 1 | Thumbnail สื่อใน Creator ไม่โหลด | Low | TC3 | [OLS-42](https://skilllane.atlassian.net/browse/OLS-42) | [→ ดู](#tc3) |
| 2 | Sidebar hamburger — กางไม่ออกหลังยุบ | Medium | C04 | [OLS-42](https://skilllane.atlassian.net/browse/OLS-42) | [→ ดู](#c04) |
| 3 | Thumbnail placeholder ยืนยันซ้ำ | Low | C04 | [OLS-42](https://skilllane.atlassian.net/browse/OLS-42) | [→ ดู](#c04) |
| 4 | "+ สร้างสื่อ" แสดงใน Learner topbar | **High** | L09 | [OLS-50](https://skilllane.atlassian.net/browse/OLS-50) | [→ ดู](#l09-deep3) |
| 5 | Search ไม่กรองผลลัพธ์ | **High** | L02 | [OLS-50](https://skilllane.atlassian.net/browse/OLS-50) | [→ ดู](#l02-search-deep4) |
| 6 | ไม่มี media type filter tab | Medium | L04 | [OLS-50](https://skilllane.atlassian.net/browse/OLS-50) | [→ ดู](#l04-filter-deep4) |
...
| # | ปัญหา | Severity | TC | Story |
|---|-------|----------|----|-------|
| 1 | Thumbnail สื่อทุกรายการใน creator ไม่โหลด แสดง placeholder เทา | Low | TC3 | [OLS-42](https://skilllane.atlassian.net/browse/OLS-42) |
...
| # | Role | TC | ปัญหา | Severity | Story |
|---|------|----|-------|----------|-------|
| 2 | Creator | C04 | Sidebar หายไปในหน้า media management (hamburger แทน) — อาจเป็น viewport/layout bug | Medium | [OLS-42](https://skilllane.atlassian.net/browse/OLS-42) |
| 3 | Creator | C04 | Thumbnail placeholder ยืนยันซ้ำ (พบทุก 10 items) | Low | [OLS-42](https://skilllane.atlassian.net/browse/OLS-42) |
...
| # | Role | TC | ปัญหา | Severity | Story |
|---|------|----|-------|----------|-------|
| 4 | Learner | L09 | ปุ่ม "+ สร้างสื่อ" (Creator feature) แสดงใน topbar ของ Learner session — role/permission UI leak | **High** | [OLS-50](https://skilllane.atlassian.net/browse/OLS-50) |
| 5 | Learner | L02 | ฟังก์ชันค้นหา `/content` ไม่กรองผลลัพธ์ — ค้น "AI" / "วิทย์" ยังคืนค่า 4,500 รายการ (ไม่ตรง OLS-50 AC_02) | **High** | [OLS-50](https://skilllane.atlassian.net/browse/OLS-50) |
| 6 | Learner | L04 | ไม่มี media type filter tab (วิดีโอ/คอร์ส/เส้นทาง) ใน /content — modal "กรองเพิ่ม" ไม่มีตัวกรองประเภท (ไม่ตรง OLS-50 AC_03) | Medium | [OLS-50](https://skilllane.atlassian.net/browse/OLS-50) |
...
## Deep Test — รอบ 5 (26 มิ.ย. 2569)

> **สถานะ:** Creator login สำเร็จ (session ผ่าน mock-ndlp-creator-token ใน regular Chrome)
> **Tools ที่ใช้ได้:** `navigate`, `read_page`, `get_page_text`, `find` (ไม่มี click/type/JS — ข้อจำกัดเดิม)
> **Session:** NDLP Creator — ทดสอบทุก pending Creator TC (C07–C18)
...
**C10 — Creator: Course List**
- Result: ✅ ผ่าน
- URL: `/creator/course`
- 5 คอร์ส: แบบร่าง 3, เผยแพร่ 2
- Status tabs: ทั้งหมด / แบบร่าง / รออนุมัติ / ไม่ผ่าน / เผยแพร่ / ถูกรายงาน / รอแก้ไข / ยกเลิก ✓
- Search box + filter dropdowns present ✓
- รายชื่อ: คอร์สอนาคตแพทย์, คอร์สอนาคตการทูต, คอร์สพัฒนาด้านภาษา, Course 2, My Course ✓

<a id="c13-deep5"></a>

**C13 — Creator: LP Management**
- Result: ✅ ผ่าน
- URL: `/creator/learning-path`
- 102 LPs: แบบร่าง 13, รออนุมัติ 9, รอแก้ไข 7, เผยแพร่ 68, ปิดใช้งาน 5
- Pagination: 11 หน้า ✓
- "สร้างเส้นทางการเรียนรู้" button visible ✓

<a id="c14-deep5"></a>

**C14 — Creator: Settings**
- Result: ✅ ผ่าน (partial — 1 tab visible)
- URL: `/creator/settings`
- Tab: "ยืนยันความเป็นเจ้าของช่อง YouTube" — input Channel ID + "เพิ่มช่อง" button ✓
- ⚠️ มีเพียง 1 tab ที่ปรากฏ — ถ้า spec กำหนดหลาย tab ให้ตรวจเพิ่มเติม

<a id="c16-deep5"></a>

**C16 — Creator: User Profile**
- Result: ✅ ผ่าน
- URL: `/creator/profile`
- ชื่อ: ธนกร วิชัยดิษฐ์ | thanakorn.w@email.com | Role: ผู้สร้างสื่อ ✓
- ผู้ติดตาม 1,240 | กำลังติดตาม 348 ✓
- Activity feed (3 items) ✓
- คลังสื่อ: สื่อ 102, คอร์ส 31, เส้นทาง 9 ✓
- สถิติ: ยอดเข้าชม 80,300, ถูกใจ 1,698, บันทึก 450 ✓
- ความสำเร็จ 20 รางวัล ✓

<a id="c18-deep5"></a>

**C18 — Creator: 404 Handling**
- Result: ✅ ผ่าน
- Navigate ไป `/creator/media/create` (URL ไม่มีจริง)
- Title: "404: This page could not be found." ✓
- App handle 404 ได้ถูกต้อง ไม่ crash ✓

---

### ⚠️ Partial — ต้องการ click/type (tool limitation)

<a id="c07-deep5"></a>

**C07 — Creator: Media Search**
- Result: ⚠️ Partial
- Search box: `textbox "ค้นหาสื่อ: ชื่อสื่อ"` visible ✓
- URL param `?search=สื่อ` ไม่กรองผล (ยังแสดง 12 รายการ) — search ต้องกด submit
- ⚠️ ยืนยัน functional search ไม่ได้ (ต้องการ type + click)

<a id="c08-deep5"></a>

**C08 — Creator: สร้างสื่อ Flow**
- Result: ⚠️ Partial
- "สร้างสื่อ" button: header (ref_12) + main content (ref_34) — ทั้ง 2 จุด ✓
- Form เป็น modal/SPA — ไม่มี dedicated URL (`/creator/media/create` → 404)
- ⚠️ ไม่สามารถทดสอบ form fields ได้ (ต้องการ click)

<a id="c11-deep5"></a>

**C11 — Creator: Create New Course**
- Result: ⚠️ Partial
- "สร้างคอร์ส" button visible บน `/creator/course` ✓
- Form เป็น modal/SPA (`/creator/course/new` → 404)
- ⚠️ ไม่สามารถทดสอบ form fields ได้ (ต้องการ click)

<a id="c12-deep5"></a>

**C12 — Creator: Course Detail/Edit**
- Result: ⚠️ Partial
- "แก้ไข" button visible ใน 5 คอร์ส ✓
- Edit page เป็น SPA navigation — ไม่มี static URL
- ⚠️ ไม่สามารถเข้าถึง edit form ได้ (ต้องการ click)

<a id="c15-deep5"></a>

**C15 — Creator: Notifications**
- Result: ⚠️ Partial
- `region "Notifications alt+T"` ปรากฏใน DOM ✓
- Keyboard shortcut: Alt+T ✓
- Panel content ไม่โหลดจนกว่าจะ trigger (lazy load)
- ⚠️ ไม่สามารถ trigger ได้ (ต้องการ click หรือ keyboard)
...
**C17 — Creator: Switch to Learner Mode**
- Result: ❌ API Error
- "เปลี่ยนเป็น Learner mode" link visible (href="/trending") ✓
- Navigate ไป `/trending` → **"ไม่สามารถโหลดข้อมูลได้: Cannot GET /trending"**
- Page title โหลดถูก ("ความรู้ติด Trend | OLS") แต่ content area แสดง API error
- ⚠️ Note: `/trending` อยู่ใน Sprint 3 (OLS-35) — error นี้น่าจะเกิดจาก backend ยังไม่พร้อม ไม่ใช่ Sprint 2 bug

---

### ข้อสังเกตทั่วไป (รอบ 5)

- **Session persistence:** Creator session ผ่าน cookies — navigate ไปทุก `/creator/*` route ได้ทันที ✓
- **Sidebar:** แสดงครบ media/course/learning-path/settings/profile + switch mode ✓
- **Bug #4 ยืนยัน:** "สร้างสื่อ" button ยังปรากฏใน header แม้จะ navigate ไปหน้า Learner (`/trending`) — **ยังไม่แก้**

---

### ข้อจำกัดของ tool ในรอบ 5
...
| `mcp__Claude_in_Chrome__get_page_text` | ✅ | ทำงานได้ปกติ |
| `mcp__Claude_in_Chrome__find` | ✅ | ทำงานได้ปกติ |
| `mcp__Claude_in_Chrome__computer` (click/type/key/screenshot) | ❌ | "Cannot access a chrome-extension:// URL of different extension" |
| `mcp__Claude_in_Chrome__javascript_tool` | ❌ | "Cannot access a chrome-extension:// URL of different extension" |
| `mcp__Control_Chrome__execute_javascript` | ❌ | "Google Chrome is not running" (แม้ Chrome รัน port 9222) |
