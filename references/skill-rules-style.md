...
**External reference:** [SkillLane claudeskill5rules](https://github.com/SkillLane/team-pluton-skills/blob/main/docs/claudeskill5rules.md) — Helix adopts the subset that fits a portable QA pack (not full 9arm folder taxonomy).
